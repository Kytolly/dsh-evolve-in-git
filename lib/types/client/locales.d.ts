...
export declare const zh: {
    ...
    'field.archiveRoot': string;
    'field.archiveRoot.hint': string;
    'field.recallTopK': string;
    'field.recallTopK.hint': string;
    'field.recallMinScore': string;
    'field.recallMinScore.hint': string;
    'field.recallMaxChars': string;
    'field.recallMaxChars.hint': string;
    'field.privacyMode': string;
    'field.privacyMode.hint': string;
    'field.privacyMode.block': string;
    'field.privacyMode.redact': string;
    'field.privacyMode.ask': string;
    'field.digestEnabled': string;
    'field.digestEnabled.hint': string;
    'field.digestMaxRecords': string;
    'field.digestMaxRecords.hint': string;
    'field.digestMaxChars': string;
    'field.digestMaxChars.hint': string;
