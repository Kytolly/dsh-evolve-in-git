window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/home/kytolly/Software/Deepseek-Harness/dsh-plugins/dsh-evolve-in-git/src/client/settings-card.module.css.mjs
		const css$1 = ".dY944G_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}.dY944G_card:hover{border-color:var(--dsw-alias-label-dimmed)}.dY944G_cardOpen{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-dimmed)}.dY944G_header{appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}.dY944G_header:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.dY944G_headerStatic{border-radius:12px;align-items:center;gap:12px;width:100%;padding:14px 16px;display:flex}.dY944G_headText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.dY944G_name{color:var(--dsw-alias-label-primary);font-size:15px;font-weight:600;line-height:1.4}.dY944G_description{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:1.5}.dY944G_pending{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.dY944G_chevron{color:var(--dsw-alias-label-tertiary);flex:none;transition:transform .16s}.dY944G_chevronOpen{transform:rotate(180deg)}.dY944G_body{border-top:1px solid var(--dsw-alias-border-l2);margin:0 16px;padding-bottom:8px}.dY944G_readOnly{color:var(--dsw-alias-label-tertiary);margin:12px 0 0;font-size:12px;line-height:1.5}.dY944G_notExposed{color:var(--dsw-alias-state-warn-primary);margin:12px 0 0;font-size:12px;line-height:1.5}.dY944G_footer{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}.dY944G_failed{min-width:0;color:var(--dsw-alias-label-error);text-overflow:ellipsis;white-space:nowrap;flex:1;margin:0;font-size:12px;line-height:1.5;overflow:hidden}.dY944G_discard,.dY944G_save{appearance:none;font:inherit;cursor:pointer;border:1px solid #0000;border-radius:8px;padding:5px 14px;font-size:13px;line-height:1.5}.dY944G_discard{border-color:var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);background:0 0}.dY944G_discard:hover:not(:disabled){color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-label-dimmed)}.dY944G_save{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3)}.dY944G_discard:disabled,.dY944G_save:disabled{opacity:.4;cursor:default}.dY944G_discard:focus-visible,.dY944G_save:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}.dY944G_field{flex-direction:column;gap:6px;padding:12px 0;display:flex}.dY944G_field+.dY944G_field{border-top:1px solid var(--dsw-alias-border-l2)}.dY944G_head{align-items:center;gap:8px;display:flex}.dY944G_label{min-width:0;color:var(--dsw-alias-label-primary);flex:1;font-size:13px;font-weight:500;line-height:1.5}.dY944G_badges{align-items:center;gap:8px;display:inline-flex}.dY944G_badge{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.dY944G_reset{font:inherit;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;padding:0;font-size:12px;line-height:1.5}.dY944G_reset:hover:not(:disabled){color:var(--dsw-alias-label-primary)}.dY944G_reset:disabled{cursor:default}.dY944G_reset:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:2px}.dY944G_input,.dY944G_select{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);height:34px;font:inherit;color:var(--dsw-alias-label-primary);border-radius:8px;padding:0 12px;font-size:13px;line-height:1.5}.dY944G_input:focus-visible,.dY944G_select:focus-visible{border-color:var(--dsw-alias-brand-primary);outline:none}.dY944G_input:disabled,.dY944G_select:disabled{color:var(--dsw-alias-label-tertiary);cursor:default}.dY944G_inputInvalid{border:1px solid var(--dsw-alias-label-error);background:var(--dsw-alias-bg-layer-3);height:34px;font:inherit;color:var(--dsw-alias-label-primary);border-radius:8px;padding:0 12px;font-size:13px;line-height:1.5}.dY944G_inputInvalid:focus-visible{outline:2px solid var(--dsw-alias-label-error);outline-offset:1px;border-color:var(--dsw-alias-label-error)}.dY944G_selectWrap{position:relative}.dY944G_selectButton{appearance:none;text-align:left;cursor:pointer;justify-content:space-between;align-items:center;gap:8px;width:100%;display:flex}.dY944G_selectLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.dY944G_selectChevron{color:var(--dsw-alias-label-tertiary);flex:none;transition:transform .16s}.dY944G_selectChevronOpen{transform:rotate(180deg)}.dY944G_selectPopup{z-index:40;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);max-height:240px;box-shadow:0 8px 24px var(--dsw-alias-bg-mask-2);opacity:0;border-radius:8px;flex-direction:column;padding:4px;transition:opacity .1s,transform .1s;display:flex;position:absolute;top:calc(100% + 4px);left:0;right:0;overflow-y:auto;transform:translateY(-4px)}.dY944G_selectPopupOpen{opacity:1;transform:none}.dY944G_selectPopupClose{opacity:0;pointer-events:none;transform:translateY(-4px)}.dY944G_selectOption{color:var(--dsw-alias-label-primary);cursor:pointer;white-space:nowrap;text-overflow:ellipsis;border-radius:6px;flex-shrink:0;padding:6px 10px;font-size:13px;line-height:1.5;overflow:hidden}.dY944G_selectOption:hover,.dY944G_selectOptionActive{background:var(--dsw-alias-interactive-bg-hover)}.dY944G_selectOptionSelected{color:var(--dsw-alias-brand-primary);background:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 10%, transparent);font-weight:500}.dY944G_invalid{color:var(--dsw-alias-label-error);margin:0;font-size:12px;line-height:1.5}.dY944G_hint{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:1.5}@media (prefers-reduced-motion:reduce){.dY944G_card,.dY944G_header,.dY944G_chevron,.dY944G_chevronOpen,.dY944G_discard,.dY944G_save,.dY944G_selectChevron,.dY944G_selectChevronOpen,.dY944G_selectPopup{transition:none}}.dY944G_configFile{border-top:1px solid var(--dsw-alias-border-l2);margin-top:8px}.dY944G_configFileHeader{appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 0 4px;display:flex}.dY944G_configFileHeader:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.dY944G_configFileBody{padding:8px 0 4px}.dY944G_textarea{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);box-sizing:border-box;width:100%;font:inherit;color:var(--dsw-alias-label-primary);resize:vertical;border-radius:8px;min-height:120px;padding:10px 12px;font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;font-size:12px;line-height:1.5}.dY944G_textarea:focus-visible{border-color:var(--dsw-alias-brand-primary);outline:none}.dY944G_textarea:disabled{color:var(--dsw-alias-label-tertiary);cursor:default}.dY944G_configFilePath{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;margin:6px 0 0;font-size:11px;line-height:1.5;overflow:hidden}.dY944G_saved{color:var(--dsw-alias-state-success-primary,var(--dsw-alias-label-primary));margin:6px 0 0;font-size:12px;line-height:1.5}";
		...
		var settings_card_module_css_default = {
			"badge": "dY944G_badge",
			"badges": "dY944G_badges",
			"body": "dY944G_body",
			"card": "dY944G_card",
			"cardOpen": "dY944G_cardOpen",
			"chevron": "dY944G_chevron",
			"chevronOpen": "dY944G_chevronOpen",
			"configFile": "dY944G_configFile",
			"configFileBody": "dY944G_configFileBody",
			"configFileHeader": "dY944G_configFileHeader",
			"configFilePath": "dY944G_configFilePath",
			"description": "dY944G_description",
			"discard": "dY944G_discard",
			"failed": "dY944G_failed",
			"field": "dY944G_field",
			"footer": "dY944G_footer",
			"head": "dY944G_head",
			"headText": "dY944G_headText",
			"header": "dY944G_header",
			"headerStatic": "dY944G_headerStatic",
			"hint": "dY944G_hint",
			"input": "dY944G_input",
			"inputInvalid": "dY944G_inputInvalid",
			"invalid": "dY944G_invalid",
			"label": "dY944G_label",
			"name": "dY944G_name",
			"notExposed": "dY944G_notExposed",
			"pending": "dY944G_pending",
			"readOnly": "dY944G_readOnly",
			"reset": "dY944G_reset",
			"save": "dY944G_save",
			"saved": "dY944G_saved",
			"select": "dY944G_select",
			"selectButton": "dY944G_selectButton",
			"selectChevron": "dY944G_selectChevron",
			"selectChevronOpen": "dY944G_selectChevronOpen",
			"selectLabel": "dY944G_selectLabel",
			"selectOption": "dY944G_selectOption",
			"selectOptionActive": "dY944G_selectOptionActive",
			"selectOptionSelected": "dY944G_selectOptionSelected",
			"selectPopup": "dY944G_selectPopup",
			"selectPopupClose": "dY944G_selectPopupClose",
			"selectPopupOpen": "dY944G_selectPopupOpen",
			"selectWrap": "dY944G_selectWrap",
			"textarea": "dY944G_textarea"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/kytolly/Software/Deepseek-Harness/dsh-plugins/dsh-evolve-in-git/src/client/settings-section.module.css.mjs
		const css = ".k_PUHW_sectionList{margin:0;padding:0;list-style:none}";
		...
		var settings_section_module_css_default = { "sectionList": "k_PUHW_sectionList" };
		//#endregion
		...
		*/
		...
		function apply(ctx) {
			...
			const controller = new EvolveSettingsCardController((ctx.get("webUiSettings") ?? ctx.settingsScope).bind({ namespace: NS }));
